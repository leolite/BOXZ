...
Update
 ...
 2012.08.02
 1. add b_skill(); include health ++; health to mana; speed ++
 2. add b_value_fixed()
 */
...
void b_skill(int keyword){
  //health exchange to mana
  if((keyword=='1')&&(value_health>1)){  //&&(value_mana<9)
    value_health -= 1;
//    value_mana +=1;
  }  
  //health ++
  if((keyword=='2')&&(value_health<10)){
    value_health += 1;
  }     
  //speed ++
  if((keyword=='f')&&(value_mana>1)){
    value_speed = 255;  
    value_mana -= 1;
  }   
  b_value_fixed();
